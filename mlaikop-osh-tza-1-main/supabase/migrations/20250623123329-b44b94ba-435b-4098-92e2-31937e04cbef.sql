...
-- Fix the log_product_activity trigger to not include product_id for DELETE operations
...
BEGIN
  ...
  ELSIF TG_OP = 'DELETE' THEN
    ...
    INSERT INTO public.recent_activity (
      ...
      business_uuid, COALESCE(auth.uid(), OLD.created_by), action_type_val, action_title,
      priority_val, status_color_val, false
    );
  END IF;
